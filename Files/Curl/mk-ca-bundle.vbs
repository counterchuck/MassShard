...
Const myCaBakF = FALSE        ' Flag: backup existing ca-bundle certificate
Const myAskLiF = FALSE        ' Flag: display certdata.txt license agreement
...
myCaFile = "Curl\Cert\ca-bundle.crt"
